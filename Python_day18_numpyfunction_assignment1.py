"""1. Suppose you have a dataset containing daily temperature readings for a
city, and you want to identify days with extreme temperature conditions.
...
temperatures = np.array([32.5, 34.2, 36.8, 29.3, 31.0, 38.7, 23.1, 18.5, 22.8, 37.22, -4, -12])
